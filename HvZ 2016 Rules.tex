...
\subsection{Noise}
\begin{enumerate}[(a)]
	\item No player, human or zombie, may make undue noise anywhere on campus, whether near academic and administrative buildings or residences.
	\item The academic program comes first and foremost on campus and distruptions to this program will be dealt with as a serious breach of the rules.
\end{enumerate}
